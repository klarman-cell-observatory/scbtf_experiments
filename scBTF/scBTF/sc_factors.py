...
class FactorizationSet:
    ...
    def save_rank_results(self, rank, restart=0, dir_path=None, entropy=1, eps=0, sample_grouping_column='sample_type'):
        """
        Save rank results.
        ...
        fig = self.plot_components(
            ...
            plot_erichment_terms=True, normalize_gene_factors=True
        )
